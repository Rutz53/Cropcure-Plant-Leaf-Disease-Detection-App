...
public class GrapeDisease extends AppCompatActivity {
    ImageView img;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_grape_disease);
    ...
    public void btng(View view){
        startActivity(new Intent(getApplicationContext(), GrapeDetection.class ));
    }
}