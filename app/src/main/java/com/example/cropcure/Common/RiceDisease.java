...
public class RiceDisease extends AppCompatActivity {
    ImageView img;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_rice_disease);
    ...
    public void btnr(View view){
        startActivity(new Intent(getApplicationContext(), RiceDetection.class ));
    }
}